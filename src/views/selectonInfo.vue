    ...
    export default {
        ...
        methods: {
            ...
            getList () {    // 待办任务
                ...
                if(this.$store.getters.getTaskCount.now !== 'B') {
                ...
                if(this.$store.getters.getTaskCount.now !== 'A') {
                    this.$store.commit('alterRefresh');
                    this.$store.commit("setLsParams", {
                        "startline":"0",
                        "statuskey":"ishandled",
        ...
        watch: {
            ...
            billmakerlist:{
                handler: function (val, oldVal) { // 发起人

                },
                deep: true
            },
            orglist:{
                handler:function (val1,oldVal1) {  // 项目组织
